Feature: code-breaker submits guess
	...
	that matches the number but not position of a number in the secret code,
	the mark includes one - sign.
	
	Each position in the secret code can only be mached once. For example, a guess
	of 1134 against a secret code of 1234 would get 3 plus signs: 1 for each of the
	exact matches in the first, third and fourth positions. The number match in the 
